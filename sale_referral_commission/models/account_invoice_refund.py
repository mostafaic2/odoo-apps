...
class AccountInvoiceRefund(models.TransientModel):
    ...
    def compute_refund(self, mode='refund'):
        ...
        inv_commissions_obj = self.env['referral.commission']
        ...
        for form in self:
            ...
            for inv in inv_obj.browse(context.get('active_ids')):
                ...
                refund.update({'ref_commission_ids':inv.ref_commission_ids})
                if mode in ('cancel', 'modify'):
                    ...
                    if mode == 'modify':
                        ...
                        print(invoice_lines)
                        referral_ids = inv_commissions_obj.browse(invoice['ref_commission_ids'])
                        ...
                        invoice.update({
                            ...
                            'ref_commission_ids': referral_ids,
                        })
